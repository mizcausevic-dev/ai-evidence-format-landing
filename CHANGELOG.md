...
### Released
- Released **ai-evidence-format-landing** publicly as a reviewable operating system for enterprise software operations.
...
### Shipped
- Cut the first coherent internal version of **ai-evidence-format-landing** with stable domain objects, review surfaces, and decision outputs.
- Established the first reviewable version of the architecture described as: Landing site for the AI Evidence Format spec. Live at evidence.kineticgain.com.
